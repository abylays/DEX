      ...
      return (
        <div>
          <div className={styles.description}>
            ...
            {utils.formatEther(cdBalance)} PEPE Tokens
            <br />
            {utils.formatEther(ethBalance)} Ether
            <br />
            {utils.formatEther(lpBalance)} ETH-PEPE LP tokens
          </div>
          <div>
            ...
            {utils.parseEther(reservedCD.toString()).eq(zero) ? (
              <div>
                ...
                <input
                  type="number"
                  placeholder="Amount of Pepe tokens"
                  onChange={(e) =>
                    setAddCDTokens(
              ...
              <div>
                ...
                <div className={styles.inputDiv}>
                  {/* Convert the BigNumber to string using the formatEther function from ethers.js */}
                  {`You will need ${utils.formatEther(addCDTokens)} PEPE
                  Tokens`}
                </div>
                <button className={styles.button1} onClick={_addLiquidity}>
                  Add
            ...
            <div>
              ...
              <div className={styles.inputDiv}>
                ...
                {`You will get ${utils.formatEther(
                  removeCD
                )} PEPE Tokens and ${utils.formatEther(removeEther)} ETH`}
              </div>
      ...
      return (
        <div>
          ...
          >
            ...
            <option value="cryptoDevToken">PEPE</option>
          </select>
          <br />
          <div className={styles.inputDiv}>
            {/* Convert the BigNumber to string using the formatEther function from ethers.js */}
  ...
  return (
    <div>
      ...
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to Pepe Exchange!</h1>
          <div className={styles.description}>
            Exchange Ethereum &#60;&#62; PEPE Tokens
          </div>
          <div>
            <button
        ...
        <div>
          <img className={styles.image} src="./pepe.png" />
        </div>
      </div>
      <footer className={styles.footer}>Made with &#10084; by Pepe Team</footer>
    </div>
  );
}
